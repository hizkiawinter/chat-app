...
function RetroGrid({
  ...
  useEffect(() => {
    ...
    const drawCell = (x: number, z: number, zOffset: number) => {
      ...
      const bottomLeft = project3DTo2D(
        x - cellWidth / 2,
        0,
        actualZ + cellDepth
      );
      const bottomRight = project3DTo2D(
        x + cellWidth / 2,
        0,
        actualZ + cellDepth
      );
    ...
    const animate = () => {
      ...
      skyGradient.addColorStop(
        0,
        `rgba(${rgb.r * 0.0}, ${rgb.g * 0.0}, ${rgb.b * 0.0}, 1)`
      );
      skyGradient.addColorStop(
        0,
        `rgba(${rgb.r * 0}, ${rgb.g * 0.0}, ${rgb.b * 0}, 1)`
      );
      skyGradient.addColorStop(
        0,
        `rgba(${rgb.r * 0}, ${rgb.g * 0}, ${rgb.b * 0}, 1)`
      );
      skyGradient.addColorStop(
        0.7,
        `rgba(${rgb.r * 0}, ${rgb.g * 0}, ${rgb.b * 0}, 1)`
